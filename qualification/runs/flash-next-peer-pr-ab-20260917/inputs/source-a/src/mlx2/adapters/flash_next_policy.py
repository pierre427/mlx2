...
class FlashNextPolicy:
    ...
    def __post_init__(self):
        if type(self.num_draft) is not int or not 1 <= self.num_draft <= 3:
        ...
        for name in ("async_qsa_promotion", "known_tail_ple_prefetch", "indexed_fused_merge", "indexed_output_gate", "allow_unverified_indexed"):
