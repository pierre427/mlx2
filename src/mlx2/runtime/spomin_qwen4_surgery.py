...
state cannot yet be repaired to match the compacted history and therefore fail
closed. Active MTP, packed/ragged caches, and non-default RoPE are likewise
